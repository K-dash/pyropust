...
# Imports used only by excluded definitions (do, Do type alias)
UNUSED_IMPORTS_IN_NATIVE = ["Generator"]
...
def extract_native_stub(init_pyi_content: str) -> str:
    ...
    while i < len(lines):
        ...
        # Skip def do (multi-line block ending with ...)
...
def main() -> None:
    ...
    print(f"📖 Reading {init_pyi}...")
    init_content = init_pyi.read_text()

    print("🔧 Extracting native module types...")
    native_content = extract_native_stub(init_content)

    print(f"📝 Writing {native_pyi}...")
